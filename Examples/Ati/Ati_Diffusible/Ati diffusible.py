...
def init(cell):
    ...
    if cell.cellType == 0:
        ...
        # Specify growth rate of cells
        cell.growthRate = random.gauss(0.02, 0.11)
    # color
    if cell.cellType == 0:
        cell.color = (1.0, 0.0, 0.0)  # RFP
    elif cell.cellType == 1:
        cell.color = (1.0, 1.0, 0.0)  # YFP
...
def update(cells):
    ...
    for (id, cell) in cells.items():
        if cell.cellType == 0:
            ...
            if cell.volume > cell.targetVol:
                cell.divideFlag = True
            if cell.signals[0] >= signal_threshold:
                cell.cellType = 2
...
def divide(parent, d1, d2):
    ...
    if d1.cellType == 0:
        ...
        d1.growthRate = random.gauss(0.02, 0.11)
    ...
    if d2.cellType == 0:
        ...
        d2.growthRate = random.gauss(0.02, 0.11)
